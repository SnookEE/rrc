...
static asn_per_constraints_t asn_PER_type_explicitList_constr_4 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  15 }	/* (SIZE(1..15)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_explicitList_constr_4 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  15 }	/* (SIZE(1..15)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_LogicalChannelList_constr_1 GCC_NOTUSED = {
...
static asn_SET_OF_specifics_t asn_SPC_explicitList_specs_4 = {
	sizeof(struct explicitList),
	offsetof(struct explicitList, _asn_ctx),
