...
static asn_TYPE_member_t asn_MBR_fddPhysicalChannelCapab_hspdsch_edch_2[] = {
	{ ATF_POINTER, 1, offsetof(struct fddPhysicalChannelCapab_hspdsch_edch, dl_CapabilityWithSimultaneousHS_DSCHConfig),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct fddPhysicalChannelCapab_hspdsch_edch, physicalChannelCapabComp_hspdsch_r6),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct fddPhysicalChannelCapab_hspdsch_edch, physicalChannelCapability_edch_r6),
...
static asn_SEQUENCE_specifics_t asn_SPC_fddPhysicalChannelCapab_hspdsch_edch_specs_2 = {
	sizeof(struct fddPhysicalChannelCapab_hspdsch_edch),
	offsetof(struct fddPhysicalChannelCapab_hspdsch_edch, _asn_ctx),
