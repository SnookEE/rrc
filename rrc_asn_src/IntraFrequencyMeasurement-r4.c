...
static const int asn_MAP_IntraFrequencyMeasurement_r4_oms_1[] = { 0, 1, 2, 3, 4 };
static const ber_tlv_tag_t asn_DEF_IntraFrequencyMeasurement_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_IntraFrequencyMeasurement_r4_tag2el_1[] = {
