...
static asn_TYPE_member_t asn_MBR_tdd384_PhysChCapability_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tdd384_PhysChCapability, downlinkPhysChCapability),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tdd384_PhysChCapability, uplinkPhysChCapability),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_tdd384_PhysChCapability_specs_5 = {
	sizeof(struct tdd384_PhysChCapability),
	offsetof(struct tdd384_PhysChCapability, _asn_ctx),
...
static const int asn_MAP_PhysicalChannelCapability_r5_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_PhysicalChannelCapability_r5_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PhysicalChannelCapability_r5_tag2el_1[] = {
