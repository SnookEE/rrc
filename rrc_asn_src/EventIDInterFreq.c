...
static asn_per_constraints_t asn_PER_type_EventIDInterFreq_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_EventIDInterFreq_value2enum_1[] = {
	{ 0,	3,	"e2a" },
	{ 1,	3,	"e2b" },
	{ 2,	3,	"e2c" },
	{ 3,	3,	"e2d" },
...
static const unsigned int asn_MAP_EventIDInterFreq_enum2value_1[] = {
	0,	/* e2a(0) */
	1,	/* e2b(1) */
	2,	/* e2c(2) */
	3,	/* e2d(3) */
...
static const asn_INTEGER_specifics_t asn_SPC_EventIDInterFreq_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_EventIDInterFreq_tags_1[] = {
