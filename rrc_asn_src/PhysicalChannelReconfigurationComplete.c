...
static asn_TYPE_member_t asn_MBR_v7xyNonCriticalExtensions_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct v7xyNonCriticalExtensions, physicalChannelReconfigurationComplete_v7xyext),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PhysicalChannelReconfigurationComplete_v7xyext_IEs,
...
static const asn_TYPE_tag2member_t asn_MAP_v7xyNonCriticalExtensions_tag2el_10[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* physicalChannelReconfigurationComplete-v7xyext */
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_8[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, physicalChannelReconfigurationComplete_r3_add_ext),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,	/* Defer constraints checking to the member type */
...
static const asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_8[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* physicalChannelReconfigurationComplete-r3-add-ext */
...
static const int asn_MAP_PhysicalChannelReconfigurationComplete_oms_1[] = { 1, 2, 3, 4, 5, 6 };
static const ber_tlv_tag_t asn_DEF_PhysicalChannelReconfigurationComplete_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PhysicalChannelReconfigurationComplete_tag2el_1[] = {
