...
static asn_per_constraints_t asn_PER_memb_ctch_AllocationPeriod_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  1,  256 }	/* (1..256) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_cbs_FrameOffset_constr_3 GCC_NOTUSED = {
