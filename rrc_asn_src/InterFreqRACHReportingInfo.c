...
static asn_TYPE_member_t asn_MBR_fdd_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct fdd, interFreqRepQuantityRACH_FDD),
...
static asn_TYPE_member_t asn_MBR_tdd_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tdd, interFreqRepQuantityRACH_TDDList),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_modeSpecificInfo_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct modeSpecificInfo, choice.interFreqRACHReportingThreshold),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct modeSpecificInfo, choice.maxReportedCellsOnRACHinterFreq),
