...
static asn_per_constraints_t asn_PER_type_MinimumSF_UL_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  4 }	/* (0..4) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_MinimumSF_UL_value2enum_1[] = {
	{ 0,	3,	"sf1" },
	{ 1,	3,	"sf2" },
	{ 2,	3,	"sf4" },
	{ 3,	3,	"sf8" },
...
static const unsigned int asn_MAP_MinimumSF_UL_enum2value_1[] = {
	4,	/* dummy(4) */
	0,	/* sf1(0) */
	1,	/* sf2(1) */
	2,	/* sf4(2) */
...
static const asn_INTEGER_specifics_t asn_SPC_MinimumSF_UL_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_MinimumSF_UL_tags_1[] = {
