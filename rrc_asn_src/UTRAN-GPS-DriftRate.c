...
static asn_per_constraints_t asn_PER_type_UTRAN_GPS_DriftRate_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_UTRAN_GPS_DriftRate_specs_1 = {
