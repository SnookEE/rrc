...
static asn_per_constraints_t asn_PER_type_VarianceOfRLC_BufferPayload_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_VarianceOfRLC_BufferPayload_specs_1 = {
