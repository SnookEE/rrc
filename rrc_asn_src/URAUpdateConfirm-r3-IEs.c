...
static const int asn_MAP_URAUpdateConfirm_r3_IEs_oms_1[] = { 1, 2, 3, 4, 6, 7, 8, 9 };
static const ber_tlv_tag_t asn_DEF_URAUpdateConfirm_r3_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_URAUpdateConfirm_r3_IEs_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* cn-InformationInfo */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* ura-Identity */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 } /* dl-CounterSynchronisationInfo */
};
