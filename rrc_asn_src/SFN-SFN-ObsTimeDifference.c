...
static asn_per_constraints_t asn_PER_type_SFN_SFN_ObsTimeDifference_constr_1 GCC_NOTUSED = {
...
static const asn_TYPE_tag2member_t asn_MAP_SFN_SFN_ObsTimeDifference_tag2el_1[] = {
