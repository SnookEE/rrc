...
static asn_per_constraints_t asn_PER_type_configuration_constr_3 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_new_Configuration_7[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct new_Configuration, pdsch_Identity),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PDSCH_Identity,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_POINTER, 1, offsetof(struct new_Configuration, pdsch_PowerControlInfo),
