...
static asn_per_constraints_t asn_PER_memb_ul_target_SIR_constr_2 GCC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_HS_SICH_Power_Control_Info_TDD768_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_HS_SICH_Power_Control_Info_TDD768_tag2el_1[] = {
