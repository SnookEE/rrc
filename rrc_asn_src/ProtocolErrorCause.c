...
static asn_per_constraints_t asn_PER_type_ProtocolErrorCause_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_ProtocolErrorCause_specs_1 = {
