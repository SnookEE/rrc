...
static asn_TYPE_member_t asn_MBR_fachCarryingMCCH_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct fachCarryingMCCH, mcch_transportFormatSet),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct fachCarryingMCCH, mcch_ConfigurationInfo),
...
static asn_SEQUENCE_specifics_t asn_SPC_fachCarryingMCCH_specs_4 = {
	sizeof(struct fachCarryingMCCH),
	offsetof(struct fachCarryingMCCH, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_fachCarryingMSCH_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct fachCarryingMSCH, msch_transportFormatSet),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_TransportFormatSet,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct fachCarryingMSCH, msch_ConfigurationInfo),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_fachCarryingMSCH_specs_8 = {
	sizeof(struct fachCarryingMSCH),
	offsetof(struct fachCarryingMSCH, _asn_ctx),
