...
static const int asn_MAP_AddOrReconfMAC_dFlow_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_AddOrReconfMAC_dFlow_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_AddOrReconfMAC_dFlow_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mac-hs-AddReconfQueue-List */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* mac-hs-DelQueue-List */
};
