...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_6[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, activeSetUpdateComplete_r3_add_ext),
...
static const asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_6[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* activeSetUpdateComplete-r3-add-ext */
...
static const int asn_MAP_ActiveSetUpdateComplete_oms_1[] = { 1, 2, 3, 4 };
static const ber_tlv_tag_t asn_DEF_ActiveSetUpdateComplete_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ActiveSetUpdateComplete_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* dummy3 */
