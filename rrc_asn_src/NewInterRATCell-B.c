...
static asn_per_constraints_t asn_PER_type_technologySpecificInfo_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_gsm_4[] = {
	{ ATF_POINTER, 1, offsetof(struct gsm, cellSelectionReselectionInfo),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct gsm, interRATCellIndividualOffset),
	...
	{ ATF_POINTER, 1, offsetof(struct gsm, dummy),
...
static asn_TYPE_member_t asn_MBR_is_2000_11[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct is_2000, is_2000SpecificMeasInfo),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_technologySpecificInfo_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct technologySpecificInfo, choice.absent),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,	/* Defer constraints checking to the member type */
