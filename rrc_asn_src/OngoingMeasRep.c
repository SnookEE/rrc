...
static const int asn_MAP_OngoingMeasRep_oms_1[] = { 2, 3 };
static const ber_tlv_tag_t asn_DEF_OngoingMeasRep_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_OngoingMeasRep_tag2el_1[] = {
