...
static asn_TYPE_member_t asn_MBR_DL_DCCH_MessageType_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType, choice.spare5),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType, choice.spare4),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType, choice.spare3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType, choice.spare2),
...
static const asn_TYPE_tag2member_t asn_MAP_DL_DCCH_MessageType_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (27 << 2)), 27, 0, 0 }, /* spare5 */
