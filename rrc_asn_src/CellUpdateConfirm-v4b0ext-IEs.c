...
static const int asn_MAP_CellUpdateConfirm_v4b0ext_IEs_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_CellUpdateConfirm_v4b0ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CellUpdateConfirm_v4b0ext_IEs_tag2el_1[] = {
