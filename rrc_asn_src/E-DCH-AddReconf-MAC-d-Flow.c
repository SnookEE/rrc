...
static asn_per_constraints_t asn_PER_memb_maxMAC_e_PDUContents_constr_8 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 15,  15,  1,  19982 }	/* (1..19982) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_ms2_NonSchedTransmGrantHARQAlloc_constr_9 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  8,  8 }	/* (SIZE(8..8)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_transmissionGrantType_constr_6 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_non_ScheduledTransGrantInfo_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct non_ScheduledTransGrantInfo, maxMAC_e_PDUContents),
	...
	{ ATF_POINTER, 1, offsetof(struct non_ScheduledTransGrantInfo, ms2_NonSchedTransmGrantHARQAlloc),
...
static asn_SEQUENCE_specifics_t asn_SPC_non_ScheduledTransGrantInfo_specs_7 = {
	sizeof(struct non_ScheduledTransGrantInfo),
	offsetof(struct non_ScheduledTransGrantInfo, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_transmissionGrantType_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct transmissionGrantType, choice.non_ScheduledTransGrantInfo),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct transmissionGrantType, choice.scheduledTransmissionGrantInfo),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,	/* Defer constraints checking to the member type */
...
static asn_CHOICE_specifics_t asn_SPC_transmissionGrantType_specs_6 = {
	sizeof(struct transmissionGrantType),
	offsetof(struct transmissionGrantType, _asn_ctx),
	offsetof(struct transmissionGrantType, present),
	sizeof(((struct transmissionGrantType *)0)->present),
