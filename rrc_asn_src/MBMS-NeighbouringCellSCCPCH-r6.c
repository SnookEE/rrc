...
static asn_per_constraints_t asn_PER_type_layer1Combining_constr_4 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_fdd_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct fdd, softComb_TimingOffset),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct fdd, mbms_L1CombiningTransmTimeDiff),
	...
	{ ATF_POINTER, 1, offsetof(struct fdd, mbms_L1CombiningSchedule),
...
static asn_TYPE_member_t asn_MBR_layer1Combining_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct layer1Combining, choice.fdd),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_fdd_5,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct layer1Combining, choice.tdd),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,	/* Defer constraints checking to the member type */
...
static asn_CHOICE_specifics_t asn_SPC_layer1Combining_specs_4 = {
	sizeof(struct layer1Combining),
	offsetof(struct layer1Combining, _asn_ctx),
	offsetof(struct layer1Combining, present),
	sizeof(((struct layer1Combining *)0)->present),
