...
static asn_TYPE_member_t asn_MBR_fdd_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct fdd, measurementPowerOffset),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct fdd, feedback_cycle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct fdd, cqi_RepetitionFactor),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct fdd, deltaCQI),
...
static const asn_TYPE_tag2member_t asn_MAP_fdd_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* measurementPowerOffset */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* feedback-cycle */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* cqi-RepetitionFactor */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* deltaCQI */
};
...
static const ber_tlv_tag_t asn_DEF_Measurement_Feedback_Info_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Measurement_Feedback_Info_tag2el_1[] = {
