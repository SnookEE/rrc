...
static asn_per_constraints_t asn_PER_type_interRATMessage_constr_4 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_gsm_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct gsm, gsm_MessageList),
...
static asn_TYPE_member_t asn_MBR_cdma2000_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct cdma2000, cdma2000_MessageList),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_cdma2000_specs_7 = {
	sizeof(struct cdma2000),
	offsetof(struct cdma2000, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_interRATMessage_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct interRATMessage, choice.gsm),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_gsm_5,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct interRATMessage, choice.cdma2000),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_cdma2000_7,
		0,	/* Defer constraints checking to the member type */
...
static asn_CHOICE_specifics_t asn_SPC_interRATMessage_specs_4 = {
	sizeof(struct interRATMessage),
	offsetof(struct interRATMessage, _asn_ctx),
	offsetof(struct interRATMessage, present),
	sizeof(((struct interRATMessage *)0)->present),
...
static asn_TYPE_member_t asn_MBR_v590NonCriticalExtensions_11[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct v590NonCriticalExtensions, handoverFromUTRANFailure_v590ext),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_9[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, handoverFromUTRANFailure_r3_add_ext),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,	/* Defer constraints checking to the member type */
