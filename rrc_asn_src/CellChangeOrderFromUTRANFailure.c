...
static asn_per_constraints_t asn_PER_type_CellChangeOrderFromUTRANFailure_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_4[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, cellChangeOrderFromUTRANFailure_r3_add_ext),
...
static asn_TYPE_member_t asn_MBR_r3_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct r3, cellChangeOrderFromUTRANFailure_r3),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_dummy_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct dummy, rrc_TransactionIdentifier),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct dummy, criticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
