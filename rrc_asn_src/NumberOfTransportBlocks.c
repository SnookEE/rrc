...
static asn_per_constraints_t asn_PER_memb_small_constr_4 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  2,  17 }	/* (2..17) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_large_constr_5 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 9,  9,  18,  512 }	/* (18..512) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_NumberOfTransportBlocks_constr_1 GCC_NOTUSED = {
