...
static const int asn_MAP_DL_InformationPerRL_r5bis_oms_1[] = { 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_DL_InformationPerRL_r5bis_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DL_InformationPerRL_r5bis_tag2el_1[] = {
