...
static asn_per_constraints_t asn_PER_type_eventSpecificParameters_constr_3 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 1,  1,  1,  2 }	/* (SIZE(1..2)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_eventSpecificParameters_constr_3 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 1,  1,  1,  2 }	/* (SIZE(1..2)) */,
	0, 0	/* No PER value map */
};
...
static asn_SET_OF_specifics_t asn_SPC_eventSpecificParameters_specs_3 = {
	sizeof(struct eventSpecificParameters),
	offsetof(struct eventSpecificParameters, _asn_ctx),
