...
static asn_per_constraints_t asn_PER_type_UL_SHCCH_MessageType_constr_1 GCC_NOTUSED = {
...
static const asn_TYPE_tag2member_t asn_MAP_UL_SHCCH_MessageType_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* puschCapacityRequest */
