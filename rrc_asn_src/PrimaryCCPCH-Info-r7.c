...
static asn_per_constraints_t asn_PER_type_syncCase_constr_13 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_per_constraints_t asn_PER_type_PrimaryCCPCH_Info_r7_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_syncCase1_14[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct syncCase1, timeslot),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_TimeslotNumber,
...
static const ber_tlv_tag_t asn_DEF_syncCase1_tags_14[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_syncCase1_tag2el_14[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* timeslot */
};
static asn_SEQUENCE_specifics_t asn_SPC_syncCase1_specs_14 = {
	sizeof(struct syncCase1),
	offsetof(struct syncCase1, _asn_ctx),
	asn_MAP_syncCase1_tag2el_14,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
...
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_syncCase1_14 = {
	"syncCase1",
	"syncCase1",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	SEQUENCE_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_syncCase1_tags_14,
	sizeof(asn_DEF_syncCase1_tags_14)
		/sizeof(asn_DEF_syncCase1_tags_14[0]) - 1, /* 1 */
	asn_DEF_syncCase1_tags_14,	/* Same as above */
	sizeof(asn_DEF_syncCase1_tags_14)
		/sizeof(asn_DEF_syncCase1_tags_14[0]), /* 2 */
	0,	/* No PER visible constraints */
	asn_MBR_syncCase1_14,
	1,	/* Elements count */
	&asn_SPC_syncCase1_specs_14	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_syncCase2_16[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct syncCase2, timeslotSync2),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_TimeslotSync2,
...
static const ber_tlv_tag_t asn_DEF_syncCase2_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_syncCase2_tag2el_16[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* timeslotSync2 */
};
static asn_SEQUENCE_specifics_t asn_SPC_syncCase2_specs_16 = {
	sizeof(struct syncCase2),
	offsetof(struct syncCase2, _asn_ctx),
	asn_MAP_syncCase2_tag2el_16,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
...
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_syncCase2_16 = {
	"syncCase2",
	"syncCase2",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	SEQUENCE_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_syncCase2_tags_16,
	sizeof(asn_DEF_syncCase2_tags_16)
		/sizeof(asn_DEF_syncCase2_tags_16[0]) - 1, /* 1 */
	asn_DEF_syncCase2_tags_16,	/* Same as above */
	sizeof(asn_DEF_syncCase2_tags_16)
		/sizeof(asn_DEF_syncCase2_tags_16[0]), /* 2 */
	0,	/* No PER visible constraints */
	asn_MBR_syncCase2_16,
	1,	/* Elements count */
	&asn_SPC_syncCase2_specs_16	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_syncCase_13[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct syncCase, choice.syncCase1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_syncCase1_14,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"syncCase1"
...
static const asn_TYPE_tag2member_t asn_MAP_syncCase_tag2el_13[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* syncCase1 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* syncCase2 */
};
static asn_CHOICE_specifics_t asn_SPC_syncCase_specs_13 = {
	sizeof(struct syncCase),
	offsetof(struct syncCase, _asn_ctx),
	offsetof(struct syncCase, present),
	sizeof(((struct syncCase *)0)->present),
	asn_MAP_syncCase_tag2el_13,
	2,	/* Count of tags in the map */
	0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_syncCase_13 = {
	"syncCase",
	"syncCase",
	CHOICE_free,
	CHOICE_print,
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_syncCase_constr_13,
	asn_MBR_syncCase_13,
	2,	/* Elements count */
	&asn_SPC_syncCase_specs_13	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_tdd768_12[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd768, syncCase),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_syncCase_13,
		0,	/* Defer constraints checking to the member type */
...
static const int asn_MAP_tdd768_oms_12[] = { 0 };
...
static asn_TYPE_member_t asn_MBR_tdd128_18[] = {
...
static const ber_tlv_tag_t asn_DEF_tdd128_tags_18[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_tdd128_tag2el_18[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* tstd-Indicator */
};
static asn_SEQUENCE_specifics_t asn_SPC_tdd128_specs_18 = {
	sizeof(struct tdd128),
	offsetof(struct tdd128, _asn_ctx),
	asn_MAP_tdd128_tag2el_18,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
...
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_tdd128_18 = {
	"tdd128",
	"tdd128",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	SEQUENCE_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_tdd128_tags_18,
	sizeof(asn_DEF_tdd128_tags_18)
		/sizeof(asn_DEF_tdd128_tags_18[0]) - 1, /* 1 */
	asn_DEF_tdd128_tags_18,	/* Same as above */
	sizeof(asn_DEF_tdd128_tags_18)
		/sizeof(asn_DEF_tdd128_tags_18[0]), /* 2 */
	0,	/* No PER visible constraints */
	asn_MBR_tdd128_18,
	1,	/* Elements count */
	&asn_SPC_tdd128_specs_18	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_PrimaryCCPCH_Info_r7_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PrimaryCCPCH_Info_r7, choice.fdd),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_fdd_2,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PrimaryCCPCH_Info_r7, choice.tdd),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_tdd_4,
		0,	/* Defer constraints checking to the member type */
...
static const asn_TYPE_tag2member_t asn_MAP_PrimaryCCPCH_Info_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* fdd */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tdd */
};
static asn_CHOICE_specifics_t asn_SPC_PrimaryCCPCH_Info_r7_specs_1 = {
	sizeof(struct PrimaryCCPCH_Info_r7),
	offsetof(struct PrimaryCCPCH_Info_r7, _asn_ctx),
	offsetof(struct PrimaryCCPCH_Info_r7, present),
	sizeof(((struct PrimaryCCPCH_Info_r7 *)0)->present),
	asn_MAP_PrimaryCCPCH_Info_r7_tag2el_1,
	2,	/* Count of tags in the map */
	0,
	-1	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_PrimaryCCPCH_Info_r7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_PrimaryCCPCH_Info_r7_constr_1,
	asn_MBR_PrimaryCCPCH_Info_r7_1,
	2,	/* Elements count */
	&asn_SPC_PrimaryCCPCH_Info_r7_specs_1	/* Additional specs */
};
