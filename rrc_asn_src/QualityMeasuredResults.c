...
static asn_TYPE_member_t asn_MBR_tdd_5[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd, sir_MeasurementResults),
...
static const asn_TYPE_tag2member_t asn_MAP_tdd_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* sir-MeasurementResults */
};
...
static const int asn_MAP_QualityMeasuredResults_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_QualityMeasuredResults_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_QualityMeasuredResults_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* blerMeasurementResultsList */
