...
static asn_per_constraints_t asn_PER_memb_edch_PhysicalLayerCategory_constr_4 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (1..16) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_fdd_edch_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_supported_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct supported, edch_PhysicalLayerCategory),
...
static asn_TYPE_member_t asn_MBR_fdd_edch_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct fdd_edch, choice.supported),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_supported_3,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct fdd_edch, choice.unsupported),
...
static asn_CHOICE_specifics_t asn_SPC_fdd_edch_specs_2 = {
	sizeof(struct fdd_edch),
	offsetof(struct fdd_edch, _asn_ctx),
	offsetof(struct fdd_edch, present),
	sizeof(((struct fdd_edch *)0)->present),
