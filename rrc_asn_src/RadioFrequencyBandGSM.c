...
static asn_per_constraints_t asn_PER_type_RadioFrequencyBandGSM_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_RadioFrequencyBandGSM_specs_1 = {
