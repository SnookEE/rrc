...
static asn_per_constraints_t asn_PER_type_measurementQuantity_constr_6 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_fdd_4[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct fdd, measurementQuantity),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
static asn_TYPE_member_t asn_MBR_tdd_11[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tdd, primaryCCPCH_RSCP),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
