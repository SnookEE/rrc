...
static asn_TYPE_member_t asn_MBR_tdd384_5[] = {
	{ ATF_POINTER, 5, offsetof(struct tdd384, timingAdvance),
	...
	{ ATF_POINTER, 4, offsetof(struct tdd384, alpha),
	...
	{ ATF_POINTER, 3, offsetof(struct tdd384, prach_ConstantValue),
	...
	{ ATF_POINTER, 2, offsetof(struct tdd384, pusch_ConstantValue),
	...
	{ ATF_POINTER, 1, offsetof(struct tdd384, openLoopPowerControl_IPDL_TDD),
...
static const int asn_MAP_tdd384_oms_5[] = { 0, 1, 2, 3, 4 };
...
static asn_TYPE_member_t asn_MBR_tdd128_11[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd128, ul_SynchronisationParameters),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_tdd128_oms_11[] = { 0 };
...
static const int asn_MAP_UplinkPhysicalChannelControl_r4_IEs_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_UplinkPhysicalChannelControl_r4_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UplinkPhysicalChannelControl_r4_IEs_tag2el_1[] = {
