...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_5[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, securityModeComplete_r3_add_ext),
...
static const asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* securityModeComplete-r3-add-ext */
...
static const int asn_MAP_SecurityModeComplete_oms_1[] = { 1, 2, 3 };
...
static const asn_TYPE_tag2member_t asn_MAP_SecurityModeComplete_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* rb-UL-CiphActivationTimeInfo */
