...
static const int asn_MAP_MBMS_L1CombiningSchedule_256_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_MBMS_L1CombiningSchedule_256_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MBMS_L1CombiningSchedule_256_tag2el_1[] = {
