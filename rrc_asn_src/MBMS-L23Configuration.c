...
static asn_per_constraints_t asn_PER_type_MBMS_L23Configuration_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_sameAsCurrent_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct sameAsCurrent, currentCell_SCCPCH),
	...
	{ ATF_POINTER, 1, offsetof(struct sameAsCurrent, msch_ConfigurationInfo),
...
static asn_SEQUENCE_specifics_t asn_SPC_sameAsCurrent_specs_2 = {
	sizeof(struct sameAsCurrent),
	offsetof(struct sameAsCurrent, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_different_5[] = {
	{ ATF_POINTER, 1, offsetof(struct different, transpCh_InfoCommonForAllTrCh),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct different, transpCHInformation),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_different_specs_5 = {
	sizeof(struct different),
	offsetof(struct different, _asn_ctx),
