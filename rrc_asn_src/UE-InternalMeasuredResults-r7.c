...
static asn_TYPE_member_t asn_MBR_fdd_3[] = {
	{ ATF_POINTER, 2, offsetof(struct fdd, ue_TransmittedPowerFDD),
	...
	{ ATF_POINTER, 1, offsetof(struct fdd, ue_RX_TX_ReportEntryList),
...
static const asn_TYPE_tag2member_t asn_MAP_fdd_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-TransmittedPowerFDD */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ue-RX-TX-ReportEntryList */
};
...
static asn_TYPE_member_t asn_MBR_tdd_6[] = {
	{ ATF_POINTER, 2, offsetof(struct tdd, ue_TransmittedPowerTDD_List),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct tdd, appliedTA),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_UL_TimingAdvance_VHCR,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"appliedTA"
...
static const int asn_MAP_tdd_oms_6[] = { 0, 1 };
...
static const asn_TYPE_tag2member_t asn_MAP_tdd_tag2el_6[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* appliedTA */
};
...
static asn_TYPE_member_t asn_MBR_UE_InternalMeasuredResults_r7_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UE_InternalMeasuredResults_r7, modeSpecificInfo),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static const ber_tlv_tag_t asn_DEF_UE_InternalMeasuredResults_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_InternalMeasuredResults_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* modeSpecificInfo */
};
static asn_SEQUENCE_specifics_t asn_SPC_UE_InternalMeasuredResults_r7_specs_1 = {
	sizeof(struct UE_InternalMeasuredResults_r7),
	offsetof(struct UE_InternalMeasuredResults_r7, _asn_ctx),
	asn_MAP_UE_InternalMeasuredResults_r7_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_UE_InternalMeasuredResults_r7 = {
	...
	SEQUENCE_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_UE_InternalMeasuredResults_r7_tags_1,
	sizeof(asn_DEF_UE_InternalMeasuredResults_r7_tags_1)
		/sizeof(asn_DEF_UE_InternalMeasuredResults_r7_tags_1[0]), /* 1 */
	asn_DEF_UE_InternalMeasuredResults_r7_tags_1,	/* Same as above */
	sizeof(asn_DEF_UE_InternalMeasuredResults_r7_tags_1)
		/sizeof(asn_DEF_UE_InternalMeasuredResults_r7_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_UE_InternalMeasuredResults_r7_1,
	1,	/* Elements count */
	&asn_SPC_UE_InternalMeasuredResults_r7_specs_1	/* Additional specs */
};
