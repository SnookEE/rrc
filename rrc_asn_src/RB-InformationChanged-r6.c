...
static asn_per_constraints_t asn_PER_type_rb_Change_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_rb_Change_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct rb_Change, choice.release),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct rb_Change, choice.re_mapToDefaultRb),
...
static const asn_TYPE_tag2member_t asn_MAP_rb_Change_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* re-mapToDefaultRb */
};
static asn_CHOICE_specifics_t asn_SPC_rb_Change_specs_3 = {
	sizeof(struct rb_Change),
	offsetof(struct rb_Change, _asn_ctx),
	offsetof(struct rb_Change, present),
	sizeof(((struct rb_Change *)0)->present),
...
static const ber_tlv_tag_t asn_DEF_RB_InformationChanged_r6_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RB_InformationChanged_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rb-Identity */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* rb-Change */
};
