...
static asn_per_constraints_t asn_PER_memb_uncertaintyCode_constr_7 GCC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_EllipsoidPointUncertCircle_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EllipsoidPointUncertCircle_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* uncertaintyCode */
};
