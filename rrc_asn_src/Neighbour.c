...
static asn_TYPE_member_t asn_MBR_fdd_3[] = {
	{ ATF_POINTER, 2, offsetof(struct fdd, neighbourIdentity),
	...
	{ ATF_POINTER, 1, offsetof(struct fdd, uE_RX_TX_TimeDifferenceType2Info),
...
static asn_TYPE_member_t asn_MBR_tdd_6[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd, neighbourAndChannelIdentity),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
