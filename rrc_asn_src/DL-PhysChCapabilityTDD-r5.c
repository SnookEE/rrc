...
static asn_per_constraints_t asn_PER_type_tdd384_hspdsch_constr_7 GCC_NOTUSED = {
...
static const asn_TYPE_tag2member_t asn_MAP_tdd384_hspdsch_tag2el_7[] = {
...
static const ber_tlv_tag_t asn_DEF_DL_PhysChCapabilityTDD_r5_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DL_PhysChCapabilityTDD_r5_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* tdd384-hspdsch */
};
