...
static asn_per_constraints_t asn_PER_memb_reference_E_TFCI_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0,  127 }	/* (0..127) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_reference_E_TFCI_PO_constr_3 GCC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_E_DPDCH_Reference_E_TFCI_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_E_DPDCH_Reference_E_TFCI_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* reference-E-TFCI */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* reference-E-TFCI-PO */
};
