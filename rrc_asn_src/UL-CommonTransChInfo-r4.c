...
static asn_TYPE_member_t asn_MBR_fdd_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct fdd, ul_TFCS),
...
static asn_TYPE_member_t asn_MBR_tdd_7[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd, individualUL_CCTrCH_InfoList),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static const int asn_MAP_UL_CommonTransChInfo_r4_oms_1[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_UL_CommonTransChInfo_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UL_CommonTransChInfo_r4_tag2el_1[] = {
