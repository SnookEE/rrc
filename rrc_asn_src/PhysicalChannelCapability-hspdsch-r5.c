...
static asn_per_constraints_t asn_PER_type_fdd_hspdsch_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_tdd384_hspdsch_constr_8 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_tdd128_hspdsch_constr_11 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_supported_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct supported, hsdsch_physical_layer_category),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct supported, dummy),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct supported, dummy2),
...
static asn_TYPE_member_t asn_MBR_fdd_hspdsch_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct fdd_hspdsch, choice.supported),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_supported_3,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct fdd_hspdsch, choice.unsupported),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,	/* Defer constraints checking to the member type */
...
static asn_CHOICE_specifics_t asn_SPC_fdd_hspdsch_specs_2 = {
	sizeof(struct fdd_hspdsch),
	offsetof(struct fdd_hspdsch, _asn_ctx),
	offsetof(struct fdd_hspdsch, present),
	sizeof(((struct fdd_hspdsch *)0)->present),
...
static asn_TYPE_member_t asn_MBR_tdd384_hspdsch_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tdd384_hspdsch, choice.supported),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_HSDSCH_physical_layer_category,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tdd384_hspdsch, choice.unsupported),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,	/* Defer constraints checking to the member type */
...
static asn_CHOICE_specifics_t asn_SPC_tdd384_hspdsch_specs_8 = {
	sizeof(struct tdd384_hspdsch),
	offsetof(struct tdd384_hspdsch, _asn_ctx),
	offsetof(struct tdd384_hspdsch, present),
	sizeof(((struct tdd384_hspdsch *)0)->present),
...
static asn_TYPE_member_t asn_MBR_tdd128_hspdsch_11[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tdd128_hspdsch, choice.supported),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_HSDSCH_physical_layer_category,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tdd128_hspdsch, choice.unsupported),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,	/* Defer constraints checking to the member type */
...
static asn_CHOICE_specifics_t asn_SPC_tdd128_hspdsch_specs_11 = {
	sizeof(struct tdd128_hspdsch),
	offsetof(struct tdd128_hspdsch, _asn_ctx),
	offsetof(struct tdd128_hspdsch, present),
	sizeof(((struct tdd128_hspdsch *)0)->present),
