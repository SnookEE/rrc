...
static asn_per_constraints_t asn_PER_memb_bitmap_constr_6 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  16,  16 }	/* (SIZE(16..16)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_codesRepresentation_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_consecutive_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct consecutive, firstChannelisationCode),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct consecutive, lastChannelisationCode),
...
static asn_TYPE_member_t asn_MBR_codesRepresentation_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct codesRepresentation, choice.consecutive),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct codesRepresentation, choice.bitmap),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
...
static asn_CHOICE_specifics_t asn_SPC_codesRepresentation_specs_2 = {
	sizeof(struct codesRepresentation),
	offsetof(struct codesRepresentation, _asn_ctx),
	offsetof(struct codesRepresentation, present),
	sizeof(((struct codesRepresentation *)0)->present),
