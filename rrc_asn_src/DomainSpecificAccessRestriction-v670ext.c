...
static asn_per_constraints_t asn_PER_type_DomainSpecificAccessRestriction_v670ext_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_restriction_3[] = {
	{ ATF_POINTER, 1, offsetof(struct restriction, domainSpecficAccessClassBarredList),
...
static asn_SEQUENCE_specifics_t asn_SPC_restriction_specs_3 = {
	...
	offsetof(struct restriction, _asn_ctx),
