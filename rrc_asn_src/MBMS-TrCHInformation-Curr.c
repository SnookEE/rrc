...
static const int asn_MAP_MBMS_TrCHInformation_Curr_oms_1[] = { 1, 2 };
static const ber_tlv_tag_t asn_DEF_MBMS_TrCHInformation_Curr_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MBMS_TrCHInformation_Curr_tag2el_1[] = {
