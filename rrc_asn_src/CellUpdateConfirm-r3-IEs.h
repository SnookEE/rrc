...
/* Dependencies */
typedef enum modeSpecificTransChInfo_PR {
	modeSpecificTransChInfo_PR_NOTHING,	/* No components present */
	modeSpecificTransChInfo_PR_fdd,
	modeSpecificTransChInfo_PR_tdd
} modeSpecificTransChInfo_PR;
...
typedef struct CellUpdateConfirm_r3_IEs {
	...
	struct modeSpecificTransChInfo {
		modeSpecificTransChInfo_PR present;
