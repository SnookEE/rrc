...
static asn_per_constraints_t asn_PER_type_UL_TimingAdvanceControl_r7_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_tdd384_5[] = {
	{ ATF_POINTER, 3, offsetof(struct tdd384, ul_TimingAdvance),
	...
	{ ATF_POINTER, 2, offsetof(struct tdd384, ext_ul_TimingAdvance),
...
static asn_TYPE_member_t asn_MBR_tdd768_9[] = {
	{ ATF_POINTER, 2, offsetof(struct tdd768, ext_ul_TimingAdvance),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_EXT_UL_TimingAdvance,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_POINTER, 1, offsetof(struct tdd768, activationTime),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ActivationTime,
		0,	/* Defer constraints checking to the member type */
