...
static const int asn_MAP_DL_HSPDSCH_Information_r6_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_DL_HSPDSCH_Information_r6_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DL_HSPDSCH_Information_r6_tag2el_1[] = {
