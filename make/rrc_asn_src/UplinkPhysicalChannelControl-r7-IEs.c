...
static asn_per_constraints_t asn_PER_type_tpc_Step_Size_constr_22 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_desired_HS_SICH_PowerLevel_constr_21 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_tdd384_5[] = {
	{ ATF_POINTER, 6, offsetof(struct tdd384, timingAdvance),
	...
	{ ATF_POINTER, 5, offsetof(struct tdd384, alpha),
	...
	{ ATF_POINTER, 4, offsetof(struct tdd384, prach_ConstantValue),
	...
	{ ATF_POINTER, 3, offsetof(struct tdd384, pusch_ConstantValue),
	...
	{ ATF_POINTER, 2, offsetof(struct tdd384, openLoopPowerControl_IPDL_TDD),
	...
	{ ATF_POINTER, 1, offsetof(struct tdd384, hs_SICH_PowerControl),
...
static asn_TYPE_member_t asn_MBR_tdd768_12[] = {
	{ ATF_POINTER, 6, offsetof(struct tdd768, timingAdvance),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct tdd768, alpha),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Alpha,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_POINTER, 4, offsetof(struct tdd768, prach_ConstantValue),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ConstantValueTdd,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_POINTER, 3, offsetof(struct tdd768, pusch_ConstantValue),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ConstantValueTdd,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_POINTER, 2, offsetof(struct tdd768, openLoopPowerControl_IPDL_TDD),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OpenLoopPowerControl_IPDL_TDD_r4,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_POINTER, 1, offsetof(struct tdd768, hs_SICH_PowerControl),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_tdd128_19[] = {
	{ ATF_POINTER, 3, offsetof(struct tdd128, ul_SynchronisationParameters),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct tdd128, desired_HS_SICH_PowerLevel),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct tdd128, tpc_Step_Size),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
