...
static asn_per_constraints_t asn_PER_type_PagingRecord_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_cn_Identity_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct cn_Identity, pagingCause),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct cn_Identity, cn_DomainIdentity),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct cn_Identity, cn_pagedUE_Identity),
...
static asn_SEQUENCE_specifics_t asn_SPC_cn_Identity_specs_2 = {
	sizeof(struct cn_Identity),
	offsetof(struct cn_Identity, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_utran_Identity_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct utran_Identity, u_RNTI),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_U_RNTI,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_POINTER, 1, offsetof(struct utran_Identity, cn_OriginatedPage_connectedMode_UE),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_utran_Identity_specs_6 = {
	sizeof(struct utran_Identity),
	offsetof(struct utran_Identity, _asn_ctx),
