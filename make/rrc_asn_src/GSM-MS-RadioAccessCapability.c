...
static asn_per_constraints_t asn_PER_type_GSM_MS_RadioAccessCapability_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
static const ber_tlv_tag_t asn_DEF_GSM_MS_RadioAccessCapability_tags_1[] = {
