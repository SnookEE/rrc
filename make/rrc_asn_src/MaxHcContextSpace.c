...
static asn_per_constraints_t asn_PER_type_MaxHcContextSpace_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_MaxHcContextSpace_specs_1 = {
