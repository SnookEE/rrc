...
static asn_per_constraints_t asn_PER_type_AccessStratumReleaseIndicator_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_AccessStratumReleaseIndicator_specs_1 = {
