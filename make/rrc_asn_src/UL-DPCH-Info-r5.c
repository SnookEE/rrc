...
static const int asn_MAP_UL_DPCH_Info_r5_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_UL_DPCH_Info_r5_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UL_DPCH_Info_r5_tag2el_1[] = {
