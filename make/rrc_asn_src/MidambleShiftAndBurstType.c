...
static asn_per_constraints_t asn_PER_type_midambleAllocationMode_constr_5 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_midambleAllocationMode_constr_12 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_midambleAllocationMode_constr_19 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_burstType_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_type1_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct type1, midambleConfigurationBurstType1and3),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct type1, midambleAllocationMode),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
static asn_TYPE_member_t asn_MBR_type2_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct type2, midambleConfigurationBurstType2),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct type2, midambleAllocationMode),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_type3_17[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct type3, midambleConfigurationBurstType1and3),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_MidambleConfigurationBurstType1and3,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct type3, midambleAllocationMode),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_type3_specs_17 = {
	sizeof(struct type3),
	offsetof(struct type3, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_burstType_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct burstType, choice.type1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_type1_3,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct burstType, choice.type2),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_type2_10,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct burstType, choice.type3),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_type3_17,
		0,	/* Defer constraints checking to the member type */
...
static asn_CHOICE_specifics_t asn_SPC_burstType_specs_2 = {
	sizeof(struct burstType),
	offsetof(struct burstType, _asn_ctx),
	offsetof(struct burstType, present),
	sizeof(((struct burstType *)0)->present),
