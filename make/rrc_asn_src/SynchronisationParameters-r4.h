...
/* Dependencies */
typedef enum sync_UL_CodesBitmap {
	sync_UL_CodesBitmap_code7	= 0,
	sync_UL_CodesBitmap_code6	= 1,
	sync_UL_CodesBitmap_code5	= 2,
	sync_UL_CodesBitmap_code4	= 3,
	sync_UL_CodesBitmap_code3	= 4,
	sync_UL_CodesBitmap_code2	= 5,
	sync_UL_CodesBitmap_code1	= 6,
	sync_UL_CodesBitmap_code0	= 7
} e_sync_UL_CodesBitmap;
