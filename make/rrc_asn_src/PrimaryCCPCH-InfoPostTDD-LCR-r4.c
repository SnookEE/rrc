...
static const ber_tlv_tag_t asn_DEF_PrimaryCCPCH_InfoPostTDD_LCR_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PrimaryCCPCH_InfoPostTDD_LCR_r4_tag2el_1[] = {
