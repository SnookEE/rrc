...
static asn_per_constraints_t asn_PER_type_confirmRequest_constr_7 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_trafficVolumeReportRequest_constr_10 GCC_NOTUSED = {
