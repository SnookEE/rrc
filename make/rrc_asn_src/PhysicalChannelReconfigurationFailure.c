...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_4[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, physicalChannelReconfigurationFailure_r3_add_ext),
...
static const asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* physicalChannelReconfigurationFailure-r3-add-ext */
...
static const int asn_MAP_PhysicalChannelReconfigurationFailure_oms_1[] = { 0, 2 };
static const ber_tlv_tag_t asn_DEF_PhysicalChannelReconfigurationFailure_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PhysicalChannelReconfigurationFailure_tag2el_1[] = {
