...
static const ber_tlv_tag_t asn_DEF_HS_SICH_Configuration_TDD768_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_HS_SICH_Configuration_TDD768_tag2el_1[] = {
