...
static asn_per_constraints_t asn_PER_type_tddOption_constr_6 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_tdd384_7[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd384, ul_CCTrCH_TimeslotsCodes),
...
static asn_TYPE_member_t asn_MBR_tdd768_9[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd768, ul_CCTrCH_TimeslotsCodes),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_tdd768_oms_9[] = { 0 };
...
static asn_TYPE_member_t asn_MBR_tdd128_11[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd128, ul_CCTrCH_TimeslotsCodes),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_UL_CCTrCH_r7_oms_1[] = { 0, 3 };
static const ber_tlv_tag_t asn_DEF_UL_CCTrCH_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UL_CCTrCH_r7_tag2el_1[] = {
