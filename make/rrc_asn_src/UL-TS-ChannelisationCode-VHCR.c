...
static asn_per_constraints_t asn_PER_type_UL_TS_ChannelisationCode_VHCR_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_UL_TS_ChannelisationCode_VHCR_specs_1 = {
