...
static asn_per_constraints_t asn_PER_type_tfcs_SignallingMode_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_tfcs_SignallingMode_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tfcs_SignallingMode, choice.explicit_config),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tfcs_SignallingMode, choice.sameAsUL),
...
static asn_CHOICE_specifics_t asn_SPC_tfcs_SignallingMode_specs_3 = {
	sizeof(struct tfcs_SignallingMode),
	offsetof(struct tfcs_SignallingMode, _asn_ctx),
	offsetof(struct tfcs_SignallingMode, present),
	sizeof(((struct tfcs_SignallingMode *)0)->present),
