...
static asn_per_constraints_t asn_PER_type_DownlinkDirectTransfer_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_4[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, downlinkDirectTransfer_r3_add_ext),
...
static asn_TYPE_member_t asn_MBR_r3_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct r3, downlinkDirectTransfer_r3),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
