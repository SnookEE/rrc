...
static asn_per_constraints_t asn_PER_type_tpc_Step_Size_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_desired_HS_SICH_PowerLevel_constr_2 GCC_NOTUSED = {
