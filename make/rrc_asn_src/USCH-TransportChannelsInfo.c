...
static asn_per_constraints_t asn_PER_type_USCH_TransportChannelsInfo_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Member, usch_TransportChannelIdentity),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Member, usch_TFS),
