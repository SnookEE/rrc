...
static asn_per_constraints_t asn_PER_type_TPC_CombinationInfoList_constr_1 GCC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_TPC_CombinationInfoList_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
