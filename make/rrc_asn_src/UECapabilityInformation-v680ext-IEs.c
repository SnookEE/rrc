...
static const ber_tlv_tag_t asn_DEF_UECapabilityInformation_v680ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UECapabilityInformation_v680ext_IEs_tag2el_1[] = {
