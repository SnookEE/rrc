...
static asn_TYPE_member_t asn_MBR_tdd384_5[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd384, pusch_TimeslotsCodes),
...
static const asn_TYPE_tag2member_t asn_MAP_tdd384_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* pusch-TimeslotsCodes */
};
...
static asn_TYPE_member_t asn_MBR_tdd128_7[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd128, pusch_TimeslotsCodes),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_PUSCH_Info_r4_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_PUSCH_Info_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PUSCH_Info_r4_tag2el_1[] = {
