...
static asn_per_constraints_t asn_PER_type_tddOption_constr_7 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_tdd384_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tdd384, appliedTA),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BOOLEAN,
		0,	/* Defer constraints checking to the member type */
...
static asn_TYPE_member_t asn_MBR_tdd128_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tdd128, t_ADVinfo),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BOOLEAN,
		0,	/* Defer constraints checking to the member type */
