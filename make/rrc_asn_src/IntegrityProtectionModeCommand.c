...
static asn_per_constraints_t asn_PER_type_IntegrityProtectionModeCommand_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_startIntegrityProtection_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct startIntegrityProtection, integrityProtInitNumber),
...
static asn_SEQUENCE_specifics_t asn_SPC_startIntegrityProtection_specs_2 = {
	sizeof(struct startIntegrityProtection),
	offsetof(struct startIntegrityProtection, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_modify_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct modify, dl_IntegrityProtActivationInfo),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_modify_specs_4 = {
	sizeof(struct modify),
	offsetof(struct modify, _asn_ctx),
