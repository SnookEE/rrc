...
static asn_TYPE_member_t asn_MBR_v590NonCriticalExtensions_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct v590NonCriticalExtensions, pagingType1_v590ext),
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_4[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, pagingType1_r3_add_ext),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,	/* Defer constraints checking to the member type */
