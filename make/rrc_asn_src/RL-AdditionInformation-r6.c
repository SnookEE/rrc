...
static asn_per_constraints_t asn_PER_type_dl_dpchInfo_constr_4 GCC_NOTUSED = {
...
static const int asn_MAP_RL_AdditionInformation_r6_oms_1[] = { 1, 3, 4 };
static const ber_tlv_tag_t asn_DEF_RL_AdditionInformation_r6_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RL_AdditionInformation_r6_tag2el_1[] = {
