...
static asn_per_constraints_t asn_PER_memb_relativeNorth_constr_15 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 16,  16, -20000,  20000 }	/* (-20000..20000) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_relativeEast_constr_16 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 16,  16, -20000,  20000 }	/* (-20000..20000) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_relativeAltitude_constr_17 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 13,  13, -4000,  4000 }	/* (-4000..4000) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_roundTripTime_constr_19 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 15,  15,  0,  32766 }	/* (0..32766) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_positioningMode_constr_13 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_ueBased_14[] = {
	{ ATF_POINTER, 5, offsetof(struct ueBased, relativeNorth),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct ueBased, relativeEast),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
	...
	{ ATF_POINTER, 3, offsetof(struct ueBased, relativeAltitude),
	...
	{ ATF_POINTER, 2, offsetof(struct ueBased, fineSFN_SFN),
