...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_5[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, radioBearerSetupFailure_r3_add_ext),
...
static const asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* radioBearerSetupFailure-r3-add-ext */
...
static const int asn_MAP_RadioBearerSetupFailure_oms_1[] = { 2, 3 };
static const ber_tlv_tag_t asn_DEF_RadioBearerSetupFailure_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RadioBearerSetupFailure_tag2el_1[] = {
