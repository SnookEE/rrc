...
static asn_per_constraints_t asn_PER_type_HandoverFromUTRANCommand_GSM_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_v690NonCriticalExtensions_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct v690NonCriticalExtensions, handoverFromUTRANCommand_GSM_v690ext),
...
static const asn_TYPE_tag2member_t asn_MAP_v690NonCriticalExtensions_tag2el_6[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* handoverFromUTRANCommand-GSM-v690ext */
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_4[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, handoverFromUTRANCommand_GSM_r3_add_ext),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,	/* Defer constraints checking to the member type */
...
static const asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* handoverFromUTRANCommand-GSM-r3-add-ext */
...
static asn_TYPE_member_t asn_MBR_r3_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct r3, handoverFromUTRANCommand_GSM_r3),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const asn_TYPE_tag2member_t asn_MAP_r3_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* handoverFromUTRANCommand-GSM-r3 */
...
static asn_TYPE_member_t asn_MBR_r6_12[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct r6, handoverFromUTRANCommand_GSM_r6),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct r6, handoverFromUTRANCommand_GSM_r6_add_ext),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,	/* Defer constraints checking to the member type */
...
static const int asn_MAP_r6_oms_12[] = { 1, 2 };
static const ber_tlv_tag_t asn_DEF_r6_tags_12[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_r6_tag2el_12[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* handoverFromUTRANCommand-GSM-r6 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* handoverFromUTRANCommand-GSM-r6-add-ext */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nonCriticalExtensions */
};
static asn_SEQUENCE_specifics_t asn_SPC_r6_specs_12 = {
	sizeof(struct r6),
	offsetof(struct r6, _asn_ctx),
	asn_MAP_r6_tag2el_12,
	3,	/* Count of tags in the map */
	asn_MAP_r6_oms_12,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_r6_12 = {
	"r6",
	"r6",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_r6_tags_12,
	sizeof(asn_DEF_r6_tags_12)
		/sizeof(asn_DEF_r6_tags_12[0]) - 1, /* 1 */
	asn_DEF_r6_tags_12,	/* Same as above */
	sizeof(asn_DEF_r6_tags_12)
		/sizeof(asn_DEF_r6_tags_12[0]), /* 2 */
	0,	/* No PER visible constraints */
	asn_MBR_r6_12,
	3,	/* Elements count */
	&asn_SPC_r6_specs_12	/* Additional specs */
};

static const ber_tlv_tag_t asn_DEF_criticalExtensions_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SEQUENCE_specifics_t asn_SPC_criticalExtensions_specs_16 = {
...
asn_TYPE_descriptor_t asn_DEF_criticalExtensions_16 = {
	...
	SEQUENCE_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_criticalExtensions_tags_16,
	sizeof(asn_DEF_criticalExtensions_tags_16)
		/sizeof(asn_DEF_criticalExtensions_tags_16[0]) - 1, /* 1 */
	asn_DEF_criticalExtensions_tags_16,	/* Same as above */
	sizeof(asn_DEF_criticalExtensions_tags_16)
		/sizeof(asn_DEF_criticalExtensions_tags_16[0]), /* 2 */
	0,	/* No PER visible constraints */
	0, 0,	/* No members */
...
static const asn_TYPE_tag2member_t asn_MAP_HandoverFromUTRANCommand_GSM_tag2el_1[] = {
