...
static asn_TYPE_member_t asn_MBR_ue_GPSTimingOfCell_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ue_GPSTimingOfCell, ms_part),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ue_GPSTimingOfCell, ls_part),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ls_part_4,
...
static const ber_tlv_tag_t asn_DEF_ue_GPSTimingOfCell_tags_2[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ue_GPSTimingOfCell_tag2el_2[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_ue_GPSTimingOfCell_specs_2 = {
	sizeof(struct ue_GPSTimingOfCell),
	offsetof(struct ue_GPSTimingOfCell, _asn_ctx),
...
static const asn_TYPE_tag2member_t asn_MAP_UTRAN_GPSReferenceTimeResult_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-GPSTimingOfCell */
