...
static const int asn_MAP_IntraFreqReportingCriteria_r6_ext_oms_1[] = { 3 };
static const ber_tlv_tag_t asn_DEF_IntraFreqReportingCriteria_r6_ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_IntraFreqReportingCriteria_r6_ext_tag2el_1[] = {
