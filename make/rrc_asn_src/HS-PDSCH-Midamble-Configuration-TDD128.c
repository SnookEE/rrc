...
static asn_per_constraints_t asn_PER_memb_ueSpecificMidamble_constr_5 GCC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_midambleConfiguration_constr_6 GCC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_HS_PDSCH_Midamble_Configuration_TDD128_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_HS_PDSCH_Midamble_Configuration_TDD128_tag2el_1[] = {
