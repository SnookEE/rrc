...
static asn_per_constraints_t asn_PER_type_UL_TransportChannelIdentity_r6_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_dch_usch_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct dch_usch, ul_TransportChannelIdentity),
