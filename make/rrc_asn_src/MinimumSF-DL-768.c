...
static asn_per_constraints_t asn_PER_type_MinimumSF_DL_768_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_MinimumSF_DL_768_value2enum_1[] = {
	{ 0,	3,	"sf1" },
	{ 1,	4,	"sf32" }
};
static const unsigned int asn_MAP_MinimumSF_DL_768_enum2value_1[] = {
	0,	/* sf1(0) */
	1	/* sf32(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_MinimumSF_DL_768_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_MinimumSF_DL_768_tags_1[] = {
