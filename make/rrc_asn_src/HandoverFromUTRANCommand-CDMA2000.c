...
static asn_per_constraints_t asn_PER_type_HandoverFromUTRANCommand_CDMA2000_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_4[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, handoverFromUTRANCommand_CDMA2000_r3_add_ext),
...
static const asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* handoverFromUTRANCommand-CDMA2000-r3-add-ext */
...
static asn_TYPE_member_t asn_MBR_r3_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct r3, handoverFromUTRANCommand_CDMA2000_r3),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const asn_TYPE_tag2member_t asn_MAP_r3_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* handoverFromUTRANCommand-CDMA2000-r3 */
...
static const asn_TYPE_tag2member_t asn_MAP_HandoverFromUTRANCommand_CDMA2000_tag2el_1[] = {
