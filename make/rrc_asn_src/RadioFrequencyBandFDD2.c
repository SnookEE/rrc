...
static asn_per_constraints_t asn_PER_type_RadioFrequencyBandFDD2_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_RadioFrequencyBandFDD2_specs_1 = {
