...
static asn_per_constraints_t asn_PER_memb_burstStart_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  15 }	/* (0..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_burstLength_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  10,  25 }	/* (10..25) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_burstFreq_constr_4 GCC_NOTUSED = {
