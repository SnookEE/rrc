...
static asn_per_constraints_t asn_PER_type_mac_hsResetIndicator_constr_8 GCC_NOTUSED = {
...
static const int asn_MAP_Serving_HSDSCH_CellInformation_oms_1[] = { 0, 1, 3, 4, 5, 6 };
static const ber_tlv_tag_t asn_DEF_Serving_HSDSCH_CellInformation_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Serving_HSDSCH_CellInformation_tag2el_1[] = {
