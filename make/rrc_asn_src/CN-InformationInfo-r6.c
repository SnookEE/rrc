...
static const int asn_MAP_CN_InformationInfo_r6_oms_1[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_CN_InformationInfo_r6_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CN_InformationInfo_r6_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* primary-plmn-Identity */
};
