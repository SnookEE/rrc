...
static asn_per_constraints_t asn_PER_memb_doppler1stOrder_constr_2 GCC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_ExtraDopplerInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ExtraDopplerInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* doppler1stOrder */
