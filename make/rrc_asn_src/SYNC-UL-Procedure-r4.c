...
static asn_per_constraints_t asn_PER_type_max_SYNC_UL_Transmissions_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_powerRampStep_constr_7 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_max_SYNC_UL_Transmissions_value2enum_2[] = {
	{ 0,	3,	"tr1" },
	{ 1,	3,	"tr2" },
	{ 2,	3,	"tr4" },
	{ 3,	3,	"tr8" }
};
static const unsigned int asn_MAP_max_SYNC_UL_Transmissions_enum2value_2[] = {
	0,	/* tr1(0) */
	1,	/* tr2(1) */
	2,	/* tr4(2) */
	3	/* tr8(3) */
};
static const asn_INTEGER_specifics_t asn_SPC_max_SYNC_UL_Transmissions_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_max_SYNC_UL_Transmissions_tags_2[] = {
...
static const ber_tlv_tag_t asn_DEF_SYNC_UL_Procedure_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SYNC_UL_Procedure_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* max-SYNC-UL-Transmissions */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* powerRampStep */
};
