...
static asn_per_constraints_t asn_PER_type_primary_Secondary_GrantSelector_constr_5 GCC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_ms2_SchedTransmGrantHARQAlloc_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_TYPE_member_t asn_MBR_servingGrant_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct servingGrant, value),
