...
static asn_per_constraints_t asn_PER_memb_ex_ul_TimingAdvance_constr_4 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  0,  255 }	/* (0..255) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_ex_ul_TimingAdvance_constr_6 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_tdd384_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tdd384, ex_ul_TimingAdvance),
...
static asn_TYPE_member_t asn_MBR_tdd768_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tdd768, ex_ul_TimingAdvance),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
