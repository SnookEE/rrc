...
static asn_per_constraints_t asn_PER_type_tdd_constr_5 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_tdd384_6[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd384, dl_HSPDSCH_TS_Configuration),
...
static asn_TYPE_member_t asn_MBR_tdd768_8[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd768, dl_HSPDSCH_TS_Configuration),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_tdd128_10[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd128, hs_PDSCH_Midamble_Configuration_tdd128),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_DL_HSPDSCH_Information_r7_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_DL_HSPDSCH_Information_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DL_HSPDSCH_Information_r7_tag2el_1[] = {
