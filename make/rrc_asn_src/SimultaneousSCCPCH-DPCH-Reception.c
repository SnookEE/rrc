...
static asn_per_constraints_t asn_PER_type_SimultaneousSCCPCH_DPCH_Reception_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_supported_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct supported, maxNoSCCPCH_RL),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct supported, simultaneousSCCPCH_DPCH_DPDCH_Reception),
