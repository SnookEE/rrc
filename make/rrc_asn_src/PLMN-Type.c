...
static asn_per_constraints_t asn_PER_type_PLMN_Type_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_gsm_MAP_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct gsm_MAP, plmn_Identity),
...
static asn_SEQUENCE_specifics_t asn_SPC_gsm_MAP_specs_2 = {
	sizeof(struct gsm_MAP),
	offsetof(struct gsm_MAP, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ansi_41_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ansi_41, p_REV),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_P_REV,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ansi_41, min_P_REV),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ansi_41, sid),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ansi_41, nid),
...
static asn_SEQUENCE_specifics_t asn_SPC_ansi_41_specs_4 = {
	sizeof(struct ansi_41),
	offsetof(struct ansi_41, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_gsm_MAP_and_ANSI_41_9[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct gsm_MAP_and_ANSI_41, plmn_Identity),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PLMN_Identity,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct gsm_MAP_and_ANSI_41, p_REV),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_P_REV,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct gsm_MAP_and_ANSI_41, min_P_REV),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Min_P_REV,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct gsm_MAP_and_ANSI_41, sid),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SID,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct gsm_MAP_and_ANSI_41, nid),
...
static asn_SEQUENCE_specifics_t asn_SPC_gsm_MAP_and_ANSI_41_specs_9 = {
	sizeof(struct gsm_MAP_and_ANSI_41),
	offsetof(struct gsm_MAP_and_ANSI_41, _asn_ctx),
