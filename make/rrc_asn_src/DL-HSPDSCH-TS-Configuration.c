...
static asn_per_constraints_t asn_PER_type_DL_HSPDSCH_TS_Configuration_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  13 }	/* (SIZE(1..13)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Member, timeslot),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Member, midambleShiftAndBurstType),
...
static const ber_tlv_tag_t asn_DEF_DL_HSPDSCH_TS_Configuration_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
