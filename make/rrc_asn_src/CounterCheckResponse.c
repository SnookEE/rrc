...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_4[] = {
	{ ATF_POINTER, 2, offsetof(struct laterNonCriticalExtensions, counterCheckResponse_r3_add_ext),
...
static const asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* counterCheckResponse-r3-add-ext */
...
static const int asn_MAP_CounterCheckResponse_oms_1[] = { 1, 2 };
...
static const asn_TYPE_tag2member_t asn_MAP_CounterCheckResponse_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* rb-COUNT-C-InformationList */
