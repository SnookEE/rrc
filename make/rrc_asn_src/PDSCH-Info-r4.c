...
static asn_TYPE_member_t asn_MBR_tdd384_5[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd384, pdsch_TimeslotsCodes),
...
static asn_TYPE_member_t asn_MBR_tdd128_7[] = {
	{ ATF_POINTER, 1, offsetof(struct tdd128, pdsch_TimeslotsCodes),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_PDSCH_Info_r4_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_PDSCH_Info_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PDSCH_Info_r4_tag2el_1[] = {
