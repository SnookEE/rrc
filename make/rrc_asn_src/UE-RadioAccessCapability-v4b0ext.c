...
static asn_TYPE_member_t asn_MBR_tdd_CapabilityExt_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tdd_CapabilityExt, rf_Capability),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tdd_CapabilityExt, physicalChannelCapability_LCR),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tdd_CapabilityExt, measurementCapability_r4_ext),
...
static asn_SEQUENCE_specifics_t asn_SPC_tdd_CapabilityExt_specs_3 = {
	sizeof(struct tdd_CapabilityExt),
	offsetof(struct tdd_CapabilityExt, _asn_ctx),
