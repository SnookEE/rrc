...
static asn_TYPE_member_t asn_MBR_hcr_r5_SpecificInfo_2[] = {
	{ ATF_POINTER, 2, offsetof(struct hcr_r5_SpecificInfo, pusch_SysInfoList_SFN),
	...
	{ ATF_POINTER, 1, offsetof(struct hcr_r5_SpecificInfo, pdsch_SysInfoList_SFN),
...
static asn_SEQUENCE_specifics_t asn_SPC_hcr_r5_SpecificInfo_specs_2 = {
	sizeof(struct hcr_r5_SpecificInfo),
	offsetof(struct hcr_r5_SpecificInfo, _asn_ctx),
