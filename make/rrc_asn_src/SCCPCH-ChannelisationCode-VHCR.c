...
static asn_per_constraints_t asn_PER_type_SCCPCH_ChannelisationCode_VHCR_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_SCCPCH_ChannelisationCode_VHCR_specs_1 = {
