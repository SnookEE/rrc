...
/* Dependencies */
typedef enum allocationConfirmation_PR {
	allocationConfirmation_PR_NOTHING,	/* No components present */
	allocationConfirmation_PR_pdschConfirmation,
	allocationConfirmation_PR_puschConfirmation
} allocationConfirmation_PR;
...
typedef struct PUSCHCapacityRequest {
	...
	struct allocationConfirmation {
		allocationConfirmation_PR present;
