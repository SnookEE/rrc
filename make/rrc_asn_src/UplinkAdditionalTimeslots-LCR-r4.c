...
static asn_per_constraints_t asn_PER_type_parameters_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_sameAsLast_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct sameAsLast, timeslotNumber),
...
static asn_SEQUENCE_specifics_t asn_SPC_sameAsLast_specs_3 = {
	sizeof(struct sameAsLast),
	offsetof(struct sameAsLast, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_newParameters_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct newParameters, individualTimeslotInfo),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct newParameters, ul_TS_ChannelisationCodeList),
...
static asn_SEQUENCE_specifics_t asn_SPC_newParameters_specs_5 = {
	sizeof(struct newParameters),
	offsetof(struct newParameters, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_parameters_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct parameters, choice.sameAsLast),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct parameters, choice.newParameters),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
