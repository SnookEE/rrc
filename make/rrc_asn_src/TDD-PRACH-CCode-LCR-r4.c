...
static asn_per_constraints_t asn_PER_type_TDD_PRACH_CCode_LCR_r4_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_TDD_PRACH_CCode_LCR_r4_specs_1 = {
