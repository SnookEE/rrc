...
static asn_per_constraints_t asn_PER_type_UE_InternalEventParam_constr_1 GCC_NOTUSED = {
...
static const asn_TYPE_tag2member_t asn_MAP_UE_InternalEventParam_tag2el_1[] = {
