...
static asn_per_constraints_t asn_PER_type_UL_ChannelRequirementWithCPCH_SetID_r5_constr_1 GCC_NOTUSED = {
...
static const asn_TYPE_tag2member_t asn_MAP_UL_ChannelRequirementWithCPCH_SetID_r5_tag2el_1[] = {
