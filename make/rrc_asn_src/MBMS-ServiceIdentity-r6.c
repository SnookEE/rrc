...
static asn_per_constraints_t asn_PER_memb_sameAsMIB_MultiPLMN_Id_constr_6 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  1,  5 }	/* (1..5) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_other_constr_5 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_plmn_Identity_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_serviceIdentity_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  3,  3 }	/* (SIZE(3..3)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_other_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct other, choice.sameAsMIB_MultiPLMN_Id),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct other, choice.explicitPLMN_Id),
...
static asn_TYPE_member_t asn_MBR_plmn_Identity_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct plmn_Identity, choice.sameAsMIB_PLMN_Id),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct plmn_Identity, choice.other),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
static asn_CHOICE_specifics_t asn_SPC_plmn_Identity_specs_3 = {
	...
	offsetof(struct plmn_Identity, present),
	sizeof(((struct plmn_Identity *)0)->present),
